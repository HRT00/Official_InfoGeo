...
_DINO_V2_MODELS = Literal["dinov2_vits14", "dinov2_vitb14", "dinov2_vitl14", "dinov2_vitl14_reg", "dinov2_vitg14", "dinov3_vitb16"]
_DINO_FACETS = Literal["query", "key", "value", "token"]

class DinoV2_style(nn.Module):
    """
    ...
    def __init__(self, model_name: _DINO_V2_MODELS, layer1: int = 39,  facet1: _DINO_FACETS = "value", use_cls=False,
        ...
        """
        super().__init__()
        self.model_name = model_name.lower()[:-6]  # 将大写转化为小写
        self.layer1 = layer1
